...
/* ── Section ──────────────────────────────────── */
function Section({ id, tag, heading, body, images, reverse, cta }) {
  const ref = useFadeIn()
  return (
      ...
      <div className="hero">
        ...
        <div className="hero-content">
          ...
          <div className="hero-actions">
            <button className="btn-primary" onClick={() => scrollTo('contact')}>Book Consultation</button>
            <button className="btn-ghost" onClick={() => scrollTo('projects')}>View Our Work</button>
          </div>
        </div>
